...
<svelte:head>
    <title>{data.set.title} — Key word transformations</title>
    <meta property="og:title" content="{data.set.title}"/>
    <meta property="og:description"
          content="{t('set.questions', { n: data.set.questions.length })} — Key word transformations"/>
</svelte:head>
